    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <InputField label="Jabatan" icon={Briefcase} name="job_title" value={formData.job_title} onChange={handleChange} placeholder="Arsitek Sistem" />
            ...
            <div className="flex justify-end items-center gap-4 pt-4 border-t border-slate-50 dark:border-slate-800">
                ...
                <button
                    type="submit"
                    className="flex items-center gap-2 px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-2xl shadow-lg shadow-indigo-100/20 transition-all active:scale-95"
                >
                    <Check size={18} />
